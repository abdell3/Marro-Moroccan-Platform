<x-layouts.app :title="'Créer un rôle | Admin'">
            ...
            <div class="bg-white dark:bg-gray-800 shadow overflow-hidden sm:rounded-lg">
                <div class="px-4 py-5 sm:px-6 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <p class="mt-1 max-w-2xl text-sm text-gray-500 dark:text-gray-400">
                        Définissez les propriétés du nouveau rôle
                    </p>
                </div>
                    ...
                    <form action="{{ route('admin.roles.store') }}" method="POST">
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <div class="mt-1">
                                    <input type="text" name="role_name" id="role_name" class="block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-white shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm" value="{{ old('role_name') }}" required>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    <textarea id="description" name="description" rows="3" class="block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-white shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm">{{ old('description') }}</textarea>
                                </div>
                            ...
                            <div>
                                        ...
                                        @foreach($permissions as $permission)
                                            <div class="flex items-start">
                                                <div class="flex items-center h-5">
                                                    <input id="permission_{{ $permission->id }}" name="permissions[]" type="checkbox" value="{{ $permission->id }}" class="focus:ring-red-500 h-4 w-4 text-red-600 border-gray-300 dark:border-gray-700 dark:bg-gray-900 rounded" {{ in_array($permission->id, old('permissions', [])) ? 'checked' : '' }}>
                                                </div>
                                ...
                                <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Sélectionnez les permissions à accorder à ce rôle.</p>
                            </div>
