<x-layouts.app :title="'Modifier mon avatar | Modérateur'">
                ...
                <div class="border-t border-gray-200 dark:border-gray-700 px-4 py-5 sm:p-6">
                    ...
                    <div class="flex flex-col md:flex-row">
                        ...
                        <div class="w-full md:w-2/3 md:pl-6 md:border-l md:border-gray-200 md:dark:border-gray-700">
                            ...
                            <form method="POST" action="{{ route('moderator.profile.avatar.update') }}" enctype="multipart/form-data" class="space-y-6">
                                @csrf
                                @method('PUT')
