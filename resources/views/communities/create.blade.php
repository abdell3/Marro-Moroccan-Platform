<x-layouts.app :title="'Créer une communauté | Marro'">
    <div class="bg-gray-100 dark:bg-gray-900 min-h-screen">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="mb-6">
                @if(isset($isModeratorContext) && $isModeratorContext)
                <a href="{{ route('moderator.communities') }}" class="text-sm text-gray-600 dark:text-gray-400 hover:text-red-600 dark:hover:text-red-400 flex items-center">
                @else
                <a href="{{ route('communities.index') }}" class="text-sm text-gray-600 dark:text-gray-400 hover:text-red-600 dark:hover:text-red-400 flex items-center">
                @endif
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
                <div class="px-4 py-5 sm:px-6 border-b border-gray-200 dark:border-gray-700">
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Créer une nouvelle communauté</h1>
                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Partagez vos passions et rassemblez des personnes partageant les mêmes intérêts.</p>
                </div>
                ...
                <div class="px-4 py-5 sm:p-6">
                    ...
                    @if(isset($isModeratorContext) && $isModeratorContext)
                    <form method="POST" action="{{ route('moderator.communities.store') }}" enctype="multipart/form-data" class="space-y-6">
                    @else
                    ...
                    @endif
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input type="text" name="theme_name" id="theme_name" class="block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-white shadow-sm focus:border-red-500 focus:ring-red-500" value="{{ old('theme_name') }}" required>
                            </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <textarea id="description" name="description" rows="4" class="block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-white shadow-sm focus:border-red-500 focus:ring-red-500">{{ old('description') }}</textarea>
                            </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <textarea id="rules" name="rules" rows="4" class="block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-white shadow-sm focus:border-red-500 focus:ring-red-500">{{ old('rules') }}</textarea>
                            </div>
