...
@if ($message)
    <div 
        ...
        {{ $attributes->merge([
            'class' => 'rounded-md p-4 ' . match($type) {
                    ...
                    <div class="-mx-1.5 -my-1.5">
                        <button 
                            ...
                            class="{{ match($type) {
                                ...
                                default => 'text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-800 focus:ring-gray-600',
                            }} rounded-md inline-flex focus:outline-none focus:ring-2 focus:ring-offset-2 p-1.5"
                        >
                            <span class="sr-only">Dismissible</span>
